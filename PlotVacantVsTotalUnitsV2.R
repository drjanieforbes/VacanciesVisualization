...
#
# File: PlotVacantVsTotalUnits.R
#
# Branch:  Geographic Research & Innovation Staff/Geography
#
# ##################################################################
#
# Plot individual census tracts as total units, vacant units, and 
# percent of the same over time
#
# ##################################################################
#
# Modules:
...
#
# The output files include columns designated that describe each
# census tract (GEOID, Census Name, Lat/Lon, etc.)
#
# 6)  Plot a randomly selected Census Tract time series for PercResVac
#	with a calculated linear model and slope of the regression line
#
# ##################################################################
